...
matlabbatch{1}.spm.spatial.coreg.estimate.source = {'iToM_localiser/iToM_localiser_0006.nii,1'};
%%
run_files = dir('iToM_localiser/iToM_localiser_*');
run_files_name = {run_files.name}; % Cells 1 to 6 are not required
files_row = [run_files_name(7:length(run_files_name))];
files_col = files_row(:);
files = strcat('iToM_localiser/',files_col,',1');
...
matlabbatch{4}.spm.spatial.coreg.estimate.source = {'iToM_localiser/iToM_localiser_0006.nii,1'};
