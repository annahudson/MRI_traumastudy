...
matlabbatch{1}.spm.spatial.coreg.estimate.source = {'iToM_run1/iToM_run1_0006.nii,1'};
%%
run_files = dir('iToM_run1/iToM_run1_*');
run_files_name = {run_files.name}; % Cells 1 to 6 are not required
files_row = [run_files_name(7:length(run_files_name))];
files_col = files_row(:);
files = strcat('iToM_run1/',files_col);
...
matlabbatch{4}.spm.spatial.coreg.estimate.source = {'iToM_run1/iToM_run1_0006.nii,1'};
