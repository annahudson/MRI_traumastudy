...
#PBS -N fs_roi_extract
#PBS -o fs_roi_extract.log
#PBS -e fs_roi_extract.err
#PBS -q default
...
mkdir -p $WORKDIR/fs_roi_extract
cd $WORKDIR/fs_roi_extract

export SUBJECTS_DIR=$WORKDIR/fs_roi_extract
echo SUBJECTS_DIR: $SUBJECTS_DIR

cp $ORIGDIR/subject_ID_anna_all.txt $WORKDIR/fs_roi_extract/subject_ID_anna_all.txt
...
for subj_id in `sed -n "${PBS_ARRAYID}p" subject_ID_anna_all.txt`; 

do

echo ${subj_id}
cp -a $ORIGDIR/${subj_id}/ $WORKDIR/fs_roi_extract
echo 'done copying'
pwd
...
printf "%s," `grep -w ${x} ${subj_id}/StructRecon_${subj_id}/stats/${side} | awk '{print $5}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%s," `grep -w ${x} ${subj_id}/StructRecon_${subj_id}/stats/${side} | awk '{print $3}'` >> CorticalMeasuresENIGMA_SurfAvg.csv

done
done

printf "%s," `cat ${subj_id}/StructRecon_${subj_id}/stats/lh.aparc.stats | grep MeanThickness | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%s," `cat ${subj_id}/StructRecon_${subj_id}/stats/rh.aparc.stats | grep MeanThickness | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%s," `cat ${subj_id}/StructRecon_${subj_id}/stats/lh.aparc.stats | grep MeanThickness | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
printf "%s," `cat ${subj_id}/StructRecon_${subj_id}/stats/rh.aparc.stats | grep MeanThickness | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
printf "%s," `cat ${subj_id}/StructRecon_${subj_id}/stats/lh.aparc.stats | grep WhiteSurfArea | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%s," `cat ${subj_id}/StructRecon_${subj_id}/stats/rh.aparc.stats | grep WhiteSurfArea | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%s," `cat ${subj_id}/StructRecon_${subj_id}/stats/lh.aparc.stats | grep WhiteSurfArea | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
printf "%s," `cat ${subj_id}/StructRecon_${subj_id}/stats/rh.aparc.stats | grep WhiteSurfArea | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
printf "%s" `cat ${subj_id}/StructRecon_${subj_id}/stats/aseg.stats | grep IntraCranialVol | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_ThickAvg.csv
printf "%s" `cat ${subj_id}/StructRecon_${subj_id}/stats/aseg.stats | grep IntraCranialVol | awk -F, '{print $4}'` >> CorticalMeasuresENIGMA_SurfAvg.csv
...
cp -a -v $WORKDIR/fs_roi_extract/CorticalMeasuresENIGMA_SurfAvg.csv $ORIGDIR/ENIGMA_CorticalThickness/
cp -a -v $WORKDIR/fs_roi_extract/CorticalMeasuresENIGMA_ThickAvg.csv $ORIGDIR/ENIGMA_CorticalThickness/
